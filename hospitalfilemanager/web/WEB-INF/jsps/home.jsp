...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <p>
                Signing up for PMR is easy! Simply click on the log in button and fill in your medical history to date. You will be given your own private key which then gives you and healthcare providers access to your information, and from then on medical updates are done automatically.
            </p>
        </div>
    </div>
</div>
